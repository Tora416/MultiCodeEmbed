...
abstract class CountingPathStorage<LabelType>(override val split: String,
...
//    protected val pathsMap: RankedIncrementalIdStorage<List<Long>> = RankedIncrementalIdStorage()
    ...
    abstract fun pathContextIdsToString(pathContextIds: List<PathContext>, label: LabelType): String

    private fun dumpPathContexts(labeledPathContextIds: LabeledPathContexts<LabelType>) {
        /*
         ...
         */
        labeledPathContextIdsWriter.println(pathContextIdsToString(labeledPathContextIds.pathContexts as List<PathContext>, labeledPathContextIds.label))
    }
...
/*    private fun storePathContext(pathContext: PathContext): PathContextId {
    ...
    override fun store(labeledPathContexts: LabeledPathContexts<LabelType>) {
        ...
        */
        dumpPathContexts(labeledPathContexts)
    }
